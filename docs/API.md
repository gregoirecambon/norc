...
This document is served by every NORC install at `https://your-norc-url/api/docs`
...
```bash
# Am I wired up?
curl -H "Authorization: Bearer $KEY" https://your-norc-url/api/ext/me
...
curl -X POST -H "Authorization: Bearer $KEY" -H "Content-Type: application/json" \
  ...
  https://your-norc-url/api/ext/tasks
```
...
All routes live under `https://your-norc-url/api/ext`.
...
```bash
curl -N -H "Authorization: Bearer $KEY" https://your-norc-url/api/ext/events
```
